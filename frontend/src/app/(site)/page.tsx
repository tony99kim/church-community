        ...
        <div className="max-w-6xl mx-auto px-4 py-14 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <div className="flex gap-3">
              <Link
                href="/posts"
                className="bg-white text-[#003478] px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-50 transition"
              >
                게시판 바로가기
              </Link>
              <Link
                href="/register"
                className="border border-white/50 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10 transition"
              >
                회원가입
              </Link>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <Link
              key={item.label}
              href={item.href}
              className={`flex items-center gap-3 bg-white rounded-xl p-4 border hover:shadow-md transition ${item.color}`}
            >
              <span className="text-2xl">{item.icon}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-[#003478] to-[#0056b3] rounded-xl p-5 text-white">
              ...
              <Link
                href="/register"
                className="block bg-white text-[#003478] text-center text-sm font-semibold py-2 rounded-lg hover:bg-blue-50 transition"
              >
                무료 회원가입
              </Link>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={s.label} className="bg-gray-50 rounded-lg p-3 text-center">
                    <div className="text-lg font-bold text-[#003478]">{s.value}</div>
